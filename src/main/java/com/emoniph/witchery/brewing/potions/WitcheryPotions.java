...
import com.emoniph.witchery.brewing.potions.PotionFrailty;
...
import com.emoniph.witchery.brewing.potions.PotionLifesteal;
import com.emoniph.witchery.brewing.potions.PotionLove;
import com.emoniph.witchery.brewing.potions.PotionManaSiphon;
...
import com.emoniph.witchery.brewing.potions.PotionPacified;
import com.emoniph.witchery.brewing.potions.PotionParalysis;
import com.emoniph.witchery.brewing.potions.PotionPhaseWalk;
import com.emoniph.witchery.brewing.potions.PotionPoisonWeapons;
import com.emoniph.witchery.brewing.potions.PotionProvoke;
...
import com.emoniph.witchery.brewing.potions.PotionRooted;
import com.emoniph.witchery.brewing.potions.PotionSinking;
import com.emoniph.witchery.brewing.potions.PotionSnowTrail;
import com.emoniph.witchery.brewing.potions.PotionSpectralSight;
...
public class WitcheryPotions {
   ...
   public final Potion BRITTLE = this.register("witchery:potion.brittle", PotionBrittle.class);
   public final Potion PHASE_WALK = this.register("witchery:potion.phasewalk", PotionPhaseWalk.class);
   public final Potion ROOTED = this.register("witchery:potion.rooted", PotionRooted.class);
   public final Potion LIFESTEAL = this.register("witchery:potion.lifesteal", PotionLifesteal.class);
   public final Potion FRAILTY = this.register("witchery:potion.frailty", PotionFrailty.class);
   public final Potion BERSERK = this.register("witchery:potion.berserk", PotionBerserk.class);
   public final Potion PACIFIED = this.register("witchery:potion.pacified", PotionPacified.class);
   public final Potion MANA_SIPHON = this.register("witchery:potion.manasiphon", PotionManaSiphon.class);
   public final Potion COMPREHENSION = this.register("witchery:potion.comprehension", PotionComprehension.class);
