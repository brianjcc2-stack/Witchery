...
public class WitcheryEntities {
   ...
   public WitcheryEntities() {
      ...
      this.NIGHTMARE = (new WitcheryEntities.LivingRef(112, EntityNightmare.class, "nightmare", this.entities)).addSpawn(10, 1, 1, EnumCreatureType.monster, BiomeDictionary.getBiomesForType(Type.MESA)).addSpawn(10, 1, 1, EnumCreatureType.monster, BiomeDictionary.getBiomesForType(Type.FOREST)).addSpawn(10, 1, 1, EnumCreatureType.monster, BiomeDictionary.getBiomesForType(Type.PLAINS)).addSpawn(10, 1, 1, EnumCreatureType.monster, BiomeDictionary.getBiomesForType(Type.SWAMP)).setEgg(983101, 0);
      this.SPECTRE = (new WitcheryEntities.LivingRef(113, EntitySpectre.class, "spectre", this.entities)).addSpawn(10, 1, 1, EnumCreatureType.monster, BiomeDictionary.getBiomesForType(Type.MESA)).addSpawn(10, 1, 1, EnumCreatureType.monster, BiomeDictionary.getBiomesForType(Type.FOREST)).addSpawn(10, 1, 1, EnumCreatureType.monster, BiomeDictionary.getBiomesForType(Type.PLAINS)).addSpawn(10, 1, 1, EnumCreatureType.monster, BiomeDictionary.getBiomesForType(Type.SWAMP)).setEgg(1052688, 16299031);
      this.POLTERGEIST = (new WitcheryEntities.LivingRef(114, EntityPoltergeist.class, "poltergeist", this.entities)).addSpawn(10, 1, 1, EnumCreatureType.monster, BiomeDictionary.getBiomesForType(Type.MESA)).addSpawn(10, 1, 1, EnumCreatureType.monster, BiomeDictionary.getBiomesForType(Type.FOREST)).addSpawn(10, 1, 1, EnumCreatureType.monster, BiomeDictionary.getBiomesForType(Type.PLAINS)).addSpawn(10, 1, 1, EnumCreatureType.monster, BiomeDictionary.getBiomesForType(Type.SWAMP)).setEgg(12844917, 12844917);
      this.BANSHEE = (new WitcheryEntities.LivingRef(115, EntityBanshee.class, "banshee", this.entities)).addSpawn(10, 1, 1, EnumCreatureType.monster, BiomeDictionary.getBiomesForType(Type.MESA)).addSpawn(10, 1, 1, EnumCreatureType.monster, BiomeDictionary.getBiomesForType(Type.FOREST)).addSpawn(10, 1, 1, EnumCreatureType.monster, BiomeDictionary.getBiomesForType(Type.PLAINS)).addSpawn(10, 1, 1, EnumCreatureType.monster, BiomeDictionary.getBiomesForType(Type.SWAMP)).setEgg(13683116, 10136945);
